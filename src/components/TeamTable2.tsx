      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="flex flex-col justify-center space-y-4">
            {["experiencia", "filosofía", "metas"].map((option) => (
              <button
                ...
                className={`text-left font-serif text-lg w-full transition-colors ${
          ...
          <div className="space-y-6">
            <div className="mb-8">
              <h1 className="text-4xl font-serif text-[#C5B358] mb-2">NOMBRE DUEÑO</h1>
              <h2 className="text-xl font-serif text-black">DUEÑO</h2>
            </div>
